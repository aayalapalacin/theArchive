...
const SizeAndColor = () => { 
  ...
  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" stroke="black" stroke-width="1"/>
</svg>
  ...
  <path fill-rule="evenodd" d="M7.646 4.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" stroke="black" stroke-width="1"/>
</svg>
  ...
  return (
      <div className="color-radio-container">
        ...
        <div className="color-radio-inner-container">
          <div onChange={(e) => updateChosenColor(e)} className={`color-radio ${expandOptions ? 'wrap' : ''}`}>
              ...
              return (
                  <label>
                    <input
                      type="radio"
                      value={index}
                      checked={chosenColor && colorOptions[chosenColor].name == colorOption.name}
                      name="color"
                    />
          ...
          <label className="expand-options-checkbox">
              <input type='checkbox' onClick={toggleExpandOptions} checked={expandOptions}></input>
